                    ...
                    <form action="{{ url('editdoctor', $data->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $data->name }}" class="form-control"
                                placeholder="Enter name" style="background: #191C24; color: white;" required>
                        </div>
                        <div class="form-group">
                            <label>Doctor's Phone Number</label>
                            <input type="text" name="phone" value="{{ $data->phone }}" class="form-control"
                                placeholder="Enter phone" style="background: #191C24; color: white;" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="room" class="custom-select mr-sm-2"
                                style="background: #191C24; width: 640px;" required>
                                <option selected>{{ $data->room }}</option>
                        ...
                        <div class="form-group">
                            <label>Doctor's Old Image</label>
                            <img src="doctorimage/{{ $data->image }}" alt="" height="150px" width="150px">
                        </div>

                        <div class="form-group">
                            <label>Change Doctor's Image</label>
                            <input type="file" name="image" class="form-control"
                                style="background: #191C24; color:white;">
                        </div>
